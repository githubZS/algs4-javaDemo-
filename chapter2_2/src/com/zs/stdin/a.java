...
public class StdInNew {
	/*** begin: section (1 of 2) of code duplicated from In to StdInNew. */
	...
	/*** end: section (1 of 2) of code duplicated from In to StdInNew. */
	...
	public StdInNew(Scanner scanner) {
		StdInNew.scanner = scanner;
	}

	// // begin: section (2 of 2) of code duplicated from In to StdInNew,
	...
	// // end: section (2 of 2) of code duplicated from In to StdInNew

	// do this once when StdInNew is initialized
	static {
		resync();
	}

	/**
	 * If StdInNew changes, use this to reinitialize the scanner.
	 */
	...
	private static void setScanner(Scanner scanner) {
		StdInNew.scanner = scanner;
		StdInNew.scanner.useLocale(LOCALE);
	}
	...
	public static void main(String[] args) {
		...
		String s = StdInNew.readString();
		StdOut.println("Your string was: " + s);
		StdOut.println();

		StdOut.print("Type an int: ");
		int a = StdInNew.readInt();
		StdOut.println("Your int was: " + a);
		StdOut.println();

		StdOut.print("Type a boolean: ");
		boolean b = StdInNew.readBoolean();
		StdOut.println("Your boolean was: " + b);
		StdOut.println();

		StdOut.print("Type a double: ");
		double c = StdInNew.readDouble();
